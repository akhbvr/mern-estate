...
export default function CreateListing() {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handeSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className="flex flex-col flex-1 gap-4">
                <p className='font-semibold'>Images: <span className="font-normal text-slate-600 ml-2">The first image will be the cover (max6)</span></p>
